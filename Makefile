LANGS  = apacheconf asm awk c cmake coffeescript colortest csharp css cython \
         ...
         markdown mpdconf nanorc nginx patch peg perl php pkg-config pkgbuild \
         po privoxy properties python rpmspec ruby sed shell sql systemd tex \
         vala vi xml xresources yaml yum
